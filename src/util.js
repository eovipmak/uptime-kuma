 ...
 * @param {any} value Raw value to parse (usually a process.env string)
 * @param {number} fallback Returned when parsing fails or falls below min
 * @param {number} min Minimum accepted integer (default 1)
